  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  "Clarity in messaging, UX and calls-to-action",
            ...
            <div id="video" className="relative">
              <div className="aspect-video rounded-xl overflow-hidden shadow-xl border border-border">
                <img
                  src="https://www.orbitmedia.com/wp-content/uploads/2024/01/website-optimization-video-thumbnail.jpg"
                  alt="Website optimization process walkthrough video thumbnail"
      ...
      <section className="dark-section text-white py-16 md:py-20">
        <div className="container-wide">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Website optimization case studies</h2>
        ...
        <div className="container-wide">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
              Why do you need website optimization services?
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="https://www.orbitmedia.com/wp-content/uploads/2024/01/before-after-chart.png"
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img
                src="https://www.orbitmedia.com/wp-content/uploads/2024/01/multi-device-mockup.png"
      ...
      <section className="section-padding bg-secondary">
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="https://www.orbitmedia.com/wp-content/uploads/2024/01/team-collaboration.jpg"
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
                We start by tapping into your site's real potential
              </h2>
              <p className="text-muted-foreground mb-4">
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-4">When it comes to SEO, one size does not fit all</h3>
              <p className="text-muted-foreground mb-6">
      ...
      <section className="section-padding bg-secondary">
        <div className="container-wide">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Meet your optimization team</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">SEO consulting & services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-bold text-foreground mb-4">SEO Strategy & Audits</h3>
              <ul className="space-y-2">
            ...
            <div>
              <h3 className="font-bold text-foreground mb-4">On-site Optimization & Content</h3>
              <ul className="space-y-2">
            ...
            <div>
              <h3 className="font-bold text-foreground mb-4">Ongoing Optimization & Reporting</h3>
              <ul className="space-y-2">
        ...
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">
              How to know if website optimization is right for you
            </h2>
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">
              What most teams ask before they hire us
            </h2>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <img
                src="https://www.orbitmedia.com/wp-content/uploads/2023/06/andy-crestodina.jpg"
                alt="Optimization team lead ready to help"
                className="w-40 h-40 rounded-full border-4 border-primary-foreground/20 object-cover"
              />
            </div>
          </div>
        </div>
